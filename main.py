...
while running:
    ...
    #colision
    #verificar avriables
    collision = is_collision(alienx_random,alieny_random,bullet_rect_x,bullet_rect_y)
    ...
    display_surface.blit(alien,(alienx_random,alieny_random))
